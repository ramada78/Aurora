...
const AiHubSEO = () => {
  return (
    <Helmet>
      <title>AI Property Hub | Aurora - Market Trends & Property Analysis</title>
      <meta name="description" content="Use Aurora's AI Property Hub to analyze real estate trends, compare property values, and get location-specific investment insights powered by advanced AI." />
      ...
      <meta property="og:title" content="AI Property Hub | Aurora" />
      ...
      <meta property="og:url" content="https://Aurora.vercel.app/ai-property-hub" />
